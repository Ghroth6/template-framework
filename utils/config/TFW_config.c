...
static int32_t TFW_ConfigCreateDefault(void) {
    ...
    // 设置默认配置项
    TFW_ConfigSetDefault(TFW_CONFIG_MAIN_VERSION, "1", TFW_CONFIG_TYPE_INT);
    TFW_ConfigSetDefault(TFW_CONFIG_MAIN_DEBUG, "false", TFW_CONFIG_TYPE_BOOL);
    TFW_ConfigSetDefault(TFW_CONFIG_MAIN_LOG_LEVEL, "1", TFW_CONFIG_TYPE_INT);
    TFW_ConfigSetDefault(TFW_CONFIG_LOGGING_LEVEL, "1", TFW_CONFIG_TYPE_INT);
    ...
    TFW_ConfigSetDefault(TFW_CONFIG_LOGGING_MAX_FILE_SIZE, "10485760", TFW_CONFIG_TYPE_INT); // 10MB
    TFW_ConfigSetDefault(TFW_CONFIG_LOGGING_MAX_RETENTION_DAYS, "7", TFW_CONFIG_TYPE_INT);
    TFW_ConfigSetDefault(TFW_CONFIG_RESOURCES_AUTO_UPDATE, "true", TFW_CONFIG_TYPE_BOOL);
    TFW_ConfigSetDefault(TFW_CONFIG_RESOURCES_UPDATE_INTERVAL, "3600", TFW_CONFIG_TYPE_INT); // 1小时
    TFW_ConfigSetDefault(TFW_CONFIG_RESOURCES_CACHE_PATH, TFW_CONFIG_DEFAULT_RESOURCES_CACHE_PATH, TFW_CONFIG_TYPE_STRING);
    TFW_ConfigSetDefault(TFW_CONFIG_SYSTEM_MAX_THREADS, "10", TFW_CONFIG_TYPE_INT);
    TFW_ConfigSetDefault(TFW_CONFIG_SYSTEM_TIMEOUT, "30", TFW_CONFIG_TYPE_INT); // 30秒
